...
class Spacing {
  ...
  static EdgeInsetsGeometry y(double spacing, {bool withResponsive = true}) {
    return Spacing.only(
        top: spacing, bottom: spacing, withResponsive: withResponsive);
  }

  static EdgeInsetsGeometry x(double spacing, {bool withResponsive = true}) {
    return Spacing.only(
        left: spacing, right: spacing, withResponsive: withResponsive);
  }

  static EdgeInsetsGeometry xy(double spacingX, double spacingY,
      {bool withResponsive = true}) {
    return Spacing.only(
        left: spacingX,
        right: spacingX,
