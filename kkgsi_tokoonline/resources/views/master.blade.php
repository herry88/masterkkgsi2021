...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" h/images/favicon.png">
    @yield('title-web')
    <!-- chartist CSS -->
...
<body>
                            ...
                            <ul id="msg_dropdown" class="mailbox dropdown-content">
                                ...
                                <li>
                                    <div class="message-center">
                                        ...
                                        <a href="#">
                                                <span class="user-img">
                                                    <img /images/users/3.jpg" alt="user" class="circle">
    ...
    <!-- This page plugin js -->
    <!-- ============================================================== -->
    <script /libs/chartist/dist/chartist.min.js"></script>
